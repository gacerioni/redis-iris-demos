#!/usr/bin/env bash
#
# start_serasa_experian_demo.sh — boot one-shot do demo Serasa Experian, do zero
# ao validado:
...
#
# Uso:
#   bash scripts/start_serasa_experian_demo.sh                # do zero, com tudo
#   bash scripts/start_serasa_experian_demo.sh --skip-setup   # só sobe (ambiente já setado)
#
...
start_demo_core "serasa_experian" "serasa-experian-demo" "Serasa Experian" "$SKIP_SETUP"
