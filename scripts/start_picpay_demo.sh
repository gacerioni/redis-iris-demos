#!/usr/bin/env bash
#
# start_picpay_demo.sh — boot one-shot do demo PicPay Assist, do zero ao validado:
...
#
# Uso:
#   bash scripts/start_picpay_demo.sh                # do zero, com tudo
#   bash scripts/start_picpay_demo.sh --skip-setup   # só sobe (ambiente já setado)
#
...
start_demo_core "picpay_assist" "picpay-assist-demo" "PicPay Assist" "$SKIP_SETUP"
