#!/usr/bin/env bash
#
# start_aiqfome_demo.sh — boot one-shot do demo aiqfome (AIQ), do zero ao validado:
...
#
# Uso:
#   bash scripts/start_aiqfome_demo.sh                # do zero, com tudo
#   bash scripts/start_aiqfome_demo.sh --skip-setup   # só sobe (ambiente já setado)
#
...
# (o reset_aiqfome_light.sh já inclui esse passo.)
...
start_demo_core "aiqfome" "aiqfome-demo" "aiqfome" "$SKIP_SETUP"
