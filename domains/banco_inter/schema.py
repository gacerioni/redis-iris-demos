"""Banco Inter (Babi) — definições de modelo de dados (single source of truth).

Banco digital (segmento Inter One) com o diferencial de feature store: a entidade
...
ENTITY_SPECS: tuple[EntitySpec, ...] = (
    # ── Customer (cliente Inter One) ───────────────────────
    EntitySpec(
        class_name="Customer",
        redis_key_template="banco_inter_customer:{customer_id}",
        ...
        fields=(
            ...
            FieldSpec("segmento", "str", "Segmento: varejo, inter_one, private", index="tag"),
            ...
            FieldSpec("score_interno", "int", "Score interno Inter (0-1000)", index="numeric", sortable=True),
    ...
    EntitySpec(
        class_name="Account",
        redis_key_template="banco_inter_account:{account_id}",
    ...
    EntitySpec(
        class_name="Card",
        redis_key_template="banco_inter_card:{card_id}",
        ...
        fields=(
            ...
            FieldSpec("produto", "str", "Produto: Inter Black, Cartão Inter, Mastercard Black, etc.", index="text"),
    ...
    EntitySpec(
        ...
        redis_key_template="banco_inter_transaction:{txn_id}",
    ...
    EntitySpec(
        ...
        redis_key_template="banco_inter_billing_cycle:{cycle_id}",
    ...
    EntitySpec(
        ...
        redis_key_template="banco_inter_investment:{investment_id}",
    ...
    EntitySpec(
        ...
        redis_key_template="banco_inter_pix_contact:{contact_id}",
    ...
    EntitySpec(
        class_name="Dispute",
        redis_key_template="banco_inter_dispute:{dispute_id}",
    ...
    EntitySpec(
        ...
        redis_key_template="banco_inter_features:{customer_id}",
    ...
    # ── Policy (políticas / ajuda Inter) ─────────────────────
    EntitySpec(
        class_name="Policy",
        redis_key_template="banco_inter_policy:{policy_id}",
        ...
        fields=(
            ...
            FieldSpec("category", "str", "Categoria: limites, contestacao, cartao, investimento, inter_one, seguranca, cashback, lgpd", index="tag"),
